...
2. **Create AWS secrets for database credentials**
   ...
   - Then repeat steps but this time to add:
     ...
     - **NOTE:** You can set the secret names to whatever you want, so long as you change them in /[learners-management-project/RDS-terraform/terraform.tfvars](https://github.com/vnrosu/learners-management-project/blob/9bb60e977db3e66fdd4f7c7d43525c0e8dbe9491/RDS-terraform/terraform.tfvars#L9)
...
8. **Amend Deployment files**
   ...
   - Edit the frontend-deployment.yaml [image name and tag](https://github.com/vnrosu/learners-management-project/blob/9bb60e977db3e66fdd4f7c7d43525c0e8dbe9491/kubernetes/frontend-deployment.yaml#L17) to match your image in DockerHub
   - Edit the backend-deployment.yaml [image name and tag](https://github.com/vnrosu/learners-management-project/blob/9bb60e977db3e66fdd4f7c7d43525c0e8dbe9491/kubernetes/backend-deployment.yaml#L17) to match your image in DockerHub
...
11. **Get the backend service load balancer**
    ...
    - Update the URL in the [frontend-app/.env](https://github.com/vnrosu/learners-management-project/blob/9bb60e977db3e66fdd4f7c7d43525c0e8dbe9491/frontend-app/.env#L1) file
...
12. **Amend Frontend Deployment file**
    ...
    - Edit the frontend-deployment.yaml [image name](https://github.com/vnrosu/learners-management-project/blob/9bb60e977db3e66fdd4f7c7d43525c0e8dbe9491/kubernetes/frontend-deployment.yaml#L17) and tag to match your new image in DockerHub
